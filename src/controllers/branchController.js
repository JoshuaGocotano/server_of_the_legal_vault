...
export const createBranch = async (req, res) => {
  try {
    ...
    const created = await branchService.createBranch({ branch_name: branch_name.toString().trim() });
...
export const updateBranch = async (req, res) => {
  try {
    ...
    const updated = await branchService.updateBranch({ id, branch_name: branch_name.toString().trim() });
